...
import { LayoutDashboard, Database, Cable, SlidersHorizontal, FlaskConical, GitCompareArrows, ListChecks, ShieldCheck, Settings2, ArrowUpRight, LogOut, Menu, X } from '@lucide/vue'
...
<template>
  <div v-if="me.isPending.value" class="full-center"><img src="/brand/evaldock-mark.png" class="brand-mark brand-mark-loading" width="48" height="48" alt="EvalDock"/><p>Opening your workbench…</p></div>
  <main v-else-if="!me.data.value" class="login-shell">
    <section class="login-story"><div class="brand"><img src="/brand/evaldock-mark.png" class="brand-mark" width="36" height="36" alt=""/> EvalDock</div><div><h1>Evaluate changes.</h1><p>Run evaluations and compare results.</p></div></section>
